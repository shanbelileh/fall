...
//        sb.append(")");
//        sb.append("V");
//        return new Signature(Opcodes.CONSTRUCTOR_NAME, sb.toString());
//    }
...
//        {
//            case Type.CHAR:
//                return Opcodes.TYPE_CHARACTER;
//            case Type.BOOLEAN:
//                return Opcodes.TYPE_BOOLEAN;
//            case Type.DOUBLE:
//                return Opcodes.TYPE_DOUBLE;
//            case Type.FLOAT:
//                return Opcodes.TYPE_FLOAT;
//            case Type.LONG:
//                return Opcodes.TYPE_LONG;
//            case Type.INT:
//                return Opcodes.TYPE_INTEGER;
//            case Type.SHORT:
//                return Opcodes.TYPE_SHORT;
//            case Type.BYTE:
//                return Opcodes.TYPE_BYTE;
//            default:
//                return type;
//        }
//    }
...
//    {
//        if (Opcodes.TYPE_INTEGER.equals(type))
//        {
//            return Type.INT_TYPE;
//        }
//        else if (Opcodes.TYPE_BOOLEAN.equals(type))
//        {
//            return Type.BOOLEAN_TYPE;
//        }
//        else if (Opcodes.TYPE_DOUBLE.equals(type))
//        {
//            return Type.DOUBLE_TYPE;
//        }
//        else if (Opcodes.TYPE_LONG.equals(type))
//        {
//            return Type.LONG_TYPE;
//        }
//        else if (Opcodes.TYPE_CHARACTER.equals(type))
//        {
//            return Type.CHAR_TYPE;
//        }
//        else if (Opcodes.TYPE_BYTE.equals(type))
//        {
//            return Type.BYTE_TYPE;
//        }
//        else if (Opcodes.TYPE_FLOAT.equals(type))
//        {
//            return Type.FLOAT_TYPE;
//        }
//        else if (Opcodes.TYPE_SHORT.equals(type))
//        {
...
//    {
//        return method.getSignature().getName().equals(Opcodes.CONSTRUCTOR_NAME);
//    }
    ...
    {
        String ver = System.getProperty("java.version").trim();
        if (ver.startsWith("12")) return Opcodes.V12;
        if (ver.startsWith("11")) return Opcodes.V11;
        if (ver.startsWith("10")) return Opcodes.V10;
        if (ver.startsWith("9")) return Opcodes.V9;
        if (ver.startsWith("1.8")) return Opcodes.V1_8;
        if (ver.startsWith("1.7")) return Opcodes.V1_7;
        if (ver.startsWith("1.6")) return Opcodes.V1_6;
        if (ver.startsWith("1.5")) return Opcodes.V1_5;
        if (ver.startsWith("1.4")) return Opcodes.V1_4;
        if (ver.startsWith("1.3")) return Opcodes.V1_3;
        if (ver.startsWith("1.2")) return Opcodes.V1_2;
        return Opcodes.V1_1;
    }
}
